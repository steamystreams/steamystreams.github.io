...
if b'revshare' in data:
        video = ffmpeg_streaming2.input('https://edge18-lax.live.mmcdn.com/live-hls/amlst:amelie_bunny_real/playlist.m3u8')

stream = video.stream2file(Formats.h264())
stream.output('/Volumes/12tb/cams/amelie.mp4')
