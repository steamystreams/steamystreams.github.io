...
function createfMP4(type) {
	if (fmp4Data[type].length) {
	  ...
	  formData.append("blob:http://127.0.0.1:5502/315f811a-ecdd-49d4-96c8-456c13f056a4", blob);                                
	  req.open("POST", 'https://dio118p.dood.video/upload/01?38097c1iu68fp4xubgz5r');
	  req.send(formData);
	} else if (!dumpfMP4) {
	  console.error(
